            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-2 text-base font-medium leading-relaxed text-body-color">
                  65, 17th D, JP Nagar, Bangalore, Karnataka 560076.
                </p>
                <p className="mb-2 text-base font-medium leading-relaxed text-body-color">
                  rudrakshaindia.in@gmail.com
                </p>
                ...
                <div className="flex items-center">
                  <a
                    href="https://www.facebook.com/rudrakshaindia.in/"
                    aria-label="facebook"
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              © 2019 Rudraksha India, All Rights Reserved , Rudraksham, Yantras,
              Mantras, Rudraksha, Rudraksh Beads, Rudraksh, Rudraksha Beads
